...
import {
  ...
  CREATE_FOG_STARTED,
  CREATE_FOG_SUCCESS, LOAD_BEST_LIST, LOAD_BEST_LIST_FAILURE, LOAD_BEST_LIST_SUCCESS,
  LOAD_USER,
  LOAD_USER_FAILED,
  LOAD_USER_SUCCESS,
  LOOSE_MUTEX_TOKEN,
...
function stateReducer(state = [], action) {
  switch (action.type) {
    ...
    case LOAD_BEST_LIST:
      return {
        ...state,
        isLoadingBestList: true,
      };
    case LOAD_BEST_LIST_SUCCESS:
    case LOAD_BEST_LIST_FAILURE:
      return {
        ...state,
        isLoadingBestList: false,
      };
    default:
      return state;
  }
